...
if uploaded_file is not None:
    ...
    if chart_type == "Bar":
        ...
        ax.set_ylabel("")  # Hide Y-axis for pie chartax.set_title(f"{metric.capitalize()} Distribution by Region")

    # Show chart in Streamlit
    st.pyplot(fig)

    # Explanation:
    # •Users can switch between Bar, Line, and Pie charts.
    # •Chart updates instantly based on selection.
    ...
    st.download_button(
        ...
        data=csv,
        file_name=f"{metric}_by_region.csv",mime="text/csv",
    )